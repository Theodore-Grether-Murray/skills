...
| [`meeting-prep`](skills/meeting-prep) | Researches a specific person before a meeting into a one-page prep sheet — who they are, their company's latest, what they've built, recent activity, how to connect, and smart questions to ask — by scraping their LinkedIn, a mini-dossier on their employer, and a web search via BrowserClaw in parallel tabs. Disambiguates the right person and uses professional sources only (never people-search/data-broker sites). Delivers the prep sheet in chat plus an auto-linked Google Doc. |
